package com.app.ngan.quanlidanhba_app.Dao;
...
import com.app.ngan.quanlidanhba_app.db.DatabaseHelper;
...
public class BlacklistDAO {
    ...
    public void DropDb(){
        database.delete(DatabaseHelper.TABLE_BLACKLIST,"",null);
    }

    public Blacklist create(final Blacklist blackList) {
        //Log.e("SDTB",blackList.phoneNumber+"  da duoc dua vao");
